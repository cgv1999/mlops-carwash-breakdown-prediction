...
2. [Как развернуть систему](#как-развернуть-систему)
3. [Доказательство работы](#доказательство-работы)
4. [Выполнение критериев](#выполнение-критериев)
...
Статистический тест показал: t = 1875.08, p-value ≈ 0.000000. Улучшенная система статистически значимо быстрее (на 42.9%).
